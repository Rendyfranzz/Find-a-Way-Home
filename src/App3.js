...
const input='px-4 rounded-md border-2 border-solid border-[#f78c00] transition ease-in-out delay-150 hover:scale-110 hover:bg-[#f78c00] duration-700'
...
const App3 = () => {
  ...
  return (
    <div className='App3 bg-cover bg-center h-full w-screen'>
      <div className='sand'>
